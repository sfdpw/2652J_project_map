    ...
    card_entry =
        ...
        '<tr><td>\
           <input type="checkbox" id="L_' + layer_index + '" onchange="master_layer_array[' + layer_index + '].toggle()">\
             </td><td><img src="legend/L_' + layer_index + '.png" width="13" height="13"\
...

  {
    ...
    if (feature_group == 'SW_main')
    
      {
       ...
       master_layer_array[layer_index].layer_description = unpack_SW_main_feature_description(property_filters);
    ...
    
      {
       ...
       master_layer_array[layer_index].toggle = 
         ...
         function() {SW_MH_layer_toggle(layer_index, master_layer_array, local_json_layer_obj,
                                          property_filters, rgba_code);}
...

      {
       ...
       master_layer_array[layer_index].toggle = 
         ...
         function() {SW_clvt_layer_toggle(layer_index, master_layer_array, local_json_layer_obj,
                                          property_filters, rgba_code);}
...

      {
       ...
       master_layer_array[layer_index].toggle = 
         ...
         function() {SW_drain_layer_toggle(layer_index, master_layer_array, local_json_layer_obj,
                                          property_filters, rgba_code);}
...

      {
       ...
       master_layer_array[layer_index].toggle = 
          ...
          function() {E_point_pole_layer_toggle(layer_index, master_layer_array, local_json_layer_obj,           
                                           property_filters, rgba_code);}
