function qty_table_generator_E_poles(qty_bid_item) {
...

        {
...

            {
...

                {
                    ...
                    pole_instance_coordinates[0][0][1] +"/" + 
                    pole_instance_coordinates[0][0][0] +                     
                    "\" target=\"_blank\">" +
