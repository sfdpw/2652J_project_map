function misc_qty_functions_flatwork_shelter_foundations(qty_bid_item) {
...

            {
...

                {
                    ...
                    payment_block +=
                        ...
                        qty_or_blank(flatwork_instance_extracted_details[3], 'SF') + '</td>\
...

                    {
                        ...
                        payment_block +=
                            ...
                            '<td class="qty_td" style="text-align:right; padding:5px">' +
                            qty_or_blank(flatwork_instance_extracted_details[2 * ff + 5], 'SF') + '</td>\
...

        {
            ...
            return_block += '<tr class="qty_tr">\
                ...
                '<tr>\
                                           ...
                                           <td class="qty_td"\
                                             ...
                                             <strong>' +
                qty_or_blank(period_totals[0], 'SF') +
                '</strong>\
                                           </td>\
...

            {
                ...
                return_block +=
                    ...
                    qty_or_blank(period_totals[2 * ff + 2], 'SF') + '</strong></td>\
