function tracking_table_generator_sw_culverts() {
  ...
  for (const sw_culvert of json_204_culverts_3["features"])
  ...
  // status sorting        
   ...
   else if (sw_culvert_row[4].includes('Replace (E) with (N) as Directed') && sw_culvert_row[9] != 'Do Not Replace')
   
     {
    ...
    
      {
       ...
       if ( sw_culvert_row[6][0].includes('SW-29') ||
            sw_culvert_row[6][0].includes('SW-30') ||
            sw_culvert_row[6][0].includes('SW-31') )
