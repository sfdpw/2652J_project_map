function tracking_table_generator_sw_mains(asset_type) {
  ...
  var return_block = 
    ...
    '<thead class="track_thead">\
      <tr>\
        ...
        <th class="track_thead" rowspan="2">Diameter / Size</th>\
        <th class="track_thead" rowspan="2">Material</th>\
...

  {
   ...
   sw_main_row[1] = "<a href=\"..\\index.html#20/" + 
                     ...
                     "\" target=\"_blank\">" +
                     sw_main.properties.PSR + "</a>";
   
   sw_main_row[2] = sw_main.properties.PIPE_DIA;
   ...
   for (var bi in sw_main.properties.PP_HISTORY)
    ...
    for (bi = 1; bi < sw_main_row[6].length; bi++ )
    
      {
       ...
       //console.log(base_sov[90]['Bid Item'], sw_main_row[6][bi].replace('SW-0','SW-'));
   ...
   if ( sw_main_row[12] == 'MCN' || sw_main_row[12] == 'NET' )
   
     {
      ...
      sw_main_row[13] = post_con_tvi_dates[sw_main_row[10]];
  ...
  // status sorting        
   ...
   
   {
    ...
    return_block += '<td class="track_td ' + row_shade + '" style="text-align:center">' + sw_main_table[rr][2] +    '</td>';
    return_block += '<td class="track_td ' + row_shade + '" style="text-align:center">' + sw_main_table[rr][3] +    '</td>';
